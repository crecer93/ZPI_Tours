...
public class ADMIN_UpdateWycieczkaActivity extends Activity {
    ...
    private String urlWycieczki = "http://zpitours.za.pl/wycieczki-pelne.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ADMIN_activity_update_wycieczka);
