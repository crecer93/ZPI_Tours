...
public class DodajWycieczkeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //zape�nienie Spinnera dla trudno�ci
        ...
        //zape�nienie Spinnera dla moderator�w
        accessModeratorzy();
    ...
    public void accessPointInsert() {
        try {
            ...
            if(sukces) {
                ...
                Toast.makeText(getApplicationContext(),
                        "Wycieczka " + nazwa + " zosta�a pomy�lnie dodana.", Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(getApplicationContext(),
                        "Dodanie nie powiod�o si�.", Toast.LENGTH_LONG).show();
            }
